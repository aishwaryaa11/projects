...
public interface CoinGame {
  ...
  /**
   * Returns the number of goals left ob board without coins on them.
   * @return number of goals left
   */
  int goalsLeft();

  /**
   * Returns true if the specified position on the board is marked with 'G'.
   * @param posn the specified position
   * @return if the position has a goal
   */
  boolean posnHasGoal(int posn);
